 ...
 */
SANWU.Interface = function(name,methods){
	//判断接口的参数个数
...
// 这个方法的目的 就是检测方法的
SANWU.Interface.ensureImplements = function(object){
	...
	for(var i = 1 , len = arguments.length; i<len; i++ ){
		...
		// 判断参数是否是接口类的类型
		if(instanceInterface.constructor !== SANWU.Interface){
